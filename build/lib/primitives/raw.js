...
exports.RawImageTypeInvalidError = exports.RawImageCodec = void 0;
var t = require("io-ts");
exports.RawImageCodec = t.intersection([
    t.type({
        imageUrl: t.string,
    }),
    t.partial({
...
exports.RawImageTypeInvalidError = RawImageTypeInvalidError;
